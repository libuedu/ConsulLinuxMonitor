...
namespace linux_Monitor
{
    ...
    void NetModel::UpdateMonitorInfo(const linux_Monitor::MonitorInfo &monitor_info)
    {
        beginResetModel();
        monitor_data_.clear();
    ...
    std::vector<QVariant> NetModel::insert_one_net_info(const linux_Monitor::NetInfo &net_info)
    {
