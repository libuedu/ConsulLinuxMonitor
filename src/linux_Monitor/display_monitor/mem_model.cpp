...
namespace linux_Monitor
{
    ...
    void MemModel::UpdateMonitorInfo(const linux_Monitor::MonitorInfo &monitor_info)
    {
        beginResetModel();
        monitor_data_.clear();
    ...
    std::vector<QVariant> MemModel::insert_one_mem_info(const linux_Monitor::MemInfo &mem_info)
    {
