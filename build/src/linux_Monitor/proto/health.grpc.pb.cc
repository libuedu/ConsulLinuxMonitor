...
void Health::Stub::experimental_async::Check(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc::health::v1::HealthCheckResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Check_, context, request, response, std::move(f));
}
...
void Health::Stub::experimental_async::Check(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc::health::v1::HealthCheckResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_Check_, context, request, response, reactor);
}
...
::grpc::ClientAsyncResponseReader< ::grpc::health::v1::HealthCheckResponse>* Health::Stub::AsyncCheckRaw(::grpc::ClientContext* context, const ::grpc::health::v1::HealthCheckRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::grpc::health::v1::HealthCheckResponse>::Create(channel_.get(), cq, rpcmethod_Check_, context, request, true);
}
...
::grpc::ClientAsyncResponseReader< ::grpc::health::v1::HealthCheckResponse>* Health::Stub::PrepareAsyncCheckRaw(::grpc::ClientContext* context, const ::grpc::health::v1::HealthCheckRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::grpc::health::v1::HealthCheckResponse>::Create(channel_.get(), cq, rpcmethod_Check_, context, request, false);
}
...
::grpc::ClientReader< ::grpc::health::v1::HealthCheckResponse>* Health::Stub::WatchRaw(::grpc::ClientContext* context, const ::grpc::health::v1::HealthCheckRequest& request) {
  return ::grpc_impl::internal::ClientReaderFactory< ::grpc::health::v1::HealthCheckResponse>::Create(channel_.get(), rpcmethod_Watch_, context, request);
}
...
void Health::Stub::experimental_async::Watch(::grpc::ClientContext* context, ::grpc::health::v1::HealthCheckRequest* request, ::grpc::experimental::ClientReadReactor< ::grpc::health::v1::HealthCheckResponse>* reactor) {
  ::grpc_impl::internal::ClientCallbackReaderFactory< ::grpc::health::v1::HealthCheckResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_Watch_, context, request, reactor);
}
...
::grpc::ClientAsyncReader< ::grpc::health::v1::HealthCheckResponse>* Health::Stub::AsyncWatchRaw(::grpc::ClientContext* context, const ::grpc::health::v1::HealthCheckRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc_impl::internal::ClientAsyncReaderFactory< ::grpc::health::v1::HealthCheckResponse>::Create(channel_.get(), cq, rpcmethod_Watch_, context, request, true, tag);
}
...
::grpc::ClientAsyncReader< ::grpc::health::v1::HealthCheckResponse>* Health::Stub::PrepareAsyncWatchRaw(::grpc::ClientContext* context, const ::grpc::health::v1::HealthCheckRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncReaderFactory< ::grpc::health::v1::HealthCheckResponse>::Create(channel_.get(), cq, rpcmethod_Watch_, context, request, false, nullptr);
}
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ServerStreamingHandler< Health::Service, ::grpc::health::v1::HealthCheckRequest, ::grpc::health::v1::HealthCheckResponse>(
          [](Health::Service* service,
             ::grpc_impl::ServerContext* ctx,
             const ::grpc::health::v1::HealthCheckRequest* req,
             ::grpc_impl::ServerWriter<::grpc::health::v1::HealthCheckResponse>* writer) {
