...
static void InitDefaultsscc_info_NetInfo_net_5finfo_2eproto() {
  ...
  {
    void* ptr = &::linux_Monitor::_NetInfo_default_instance_;
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_net_5finfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::NetInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::NetInfo, name_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::NetInfo, send_rate_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::NetInfo, rcv_rate_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::NetInfo, send_packets_rate_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::NetInfo, rcv_packets_rate_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::linux_Monitor::NetInfo)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::linux_Monitor::_NetInfo_default_instance_),
};

const char descriptor_table_protodef_net_5finfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016net_info.proto\022\rlinux_Monitor\"q\n\007NetIn"
...
NetInfo::NetInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:linux_Monitor.NetInfo)
}
NetInfo::NetInfo(const NetInfo& from)
  ...
  // @@protoc_insertion_point(copy_constructor:linux_Monitor.NetInfo)
}
...
NetInfo::~NetInfo() {
  // @@protoc_insertion_point(destructor:linux_Monitor.NetInfo)
  SharedDtor();
...
void NetInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:linux_Monitor.NetInfo)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "linux_Monitor.NetInfo.name"));
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* NetInfo::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:linux_Monitor.NetInfo)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:linux_Monitor.NetInfo)
  return target;
}

size_t NetInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:linux_Monitor.NetInfo)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:linux_Monitor.NetInfo)
  GOOGLE_DCHECK_NE(&from, this);
  const NetInfo* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<NetInfo>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:linux_Monitor.NetInfo)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:linux_Monitor.NetInfo)
    MergeFrom(*source);
  }
}

void NetInfo::MergeFrom(const NetInfo& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:linux_Monitor.NetInfo)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:linux_Monitor.NetInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:linux_Monitor.NetInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::linux_Monitor::NetInfo* Arena::CreateMaybeMessage< ::linux_Monitor::NetInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::linux_Monitor::NetInfo >(arena);
}
