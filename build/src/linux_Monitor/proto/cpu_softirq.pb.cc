...
static void InitDefaultsscc_info_SoftIrq_cpu_5fsoftirq_2eproto() {
  ...
  {
    void* ptr = &::linux_Monitor::_SoftIrq_default_instance_;
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_cpu_5fsoftirq_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::SoftIrq, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::SoftIrq, cpu_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::SoftIrq, hi_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::SoftIrq, timer_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::SoftIrq, net_tx_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::SoftIrq, net_rx_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::SoftIrq, block_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::SoftIrq, irq_poll_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::SoftIrq, tasklet_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::SoftIrq, sched_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::SoftIrq, hrtimer_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::SoftIrq, rcu_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::linux_Monitor::SoftIrq)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::linux_Monitor::_SoftIrq_default_instance_),
};

const char descriptor_table_protodef_cpu_5fsoftirq_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021cpu_softirq.proto\022\rlinux_Monitor\"\260\001\n\007S"
...
SoftIrq::SoftIrq(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:linux_Monitor.SoftIrq)
}
SoftIrq::SoftIrq(const SoftIrq& from)
  ...
  // @@protoc_insertion_point(copy_constructor:linux_Monitor.SoftIrq)
}
...
SoftIrq::~SoftIrq() {
  // @@protoc_insertion_point(destructor:linux_Monitor.SoftIrq)
  SharedDtor();
...
void SoftIrq::Clear() {
// @@protoc_insertion_point(message_clear_start:linux_Monitor.SoftIrq)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "linux_Monitor.SoftIrq.cpu"));
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* SoftIrq::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:linux_Monitor.SoftIrq)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:linux_Monitor.SoftIrq)
  return target;
}

size_t SoftIrq::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:linux_Monitor.SoftIrq)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:linux_Monitor.SoftIrq)
  GOOGLE_DCHECK_NE(&from, this);
  const SoftIrq* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<SoftIrq>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:linux_Monitor.SoftIrq)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:linux_Monitor.SoftIrq)
    MergeFrom(*source);
  }
}

void SoftIrq::MergeFrom(const SoftIrq& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:linux_Monitor.SoftIrq)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:linux_Monitor.SoftIrq)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:linux_Monitor.SoftIrq)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::linux_Monitor::SoftIrq* Arena::CreateMaybeMessage< ::linux_Monitor::SoftIrq >(Arena* arena) {
  return Arena::CreateMessageInternal< ::linux_Monitor::SoftIrq >(arena);
}
