 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void Check(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc::health::v1::HealthCheckResponse* response, std::function<void(::grpc::Status)>) = 0;
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void Check(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc::health::v1::HealthCheckResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void Check(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc::health::v1::HealthCheckResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // Performs a watch for the serving status of the requested service.
      // The server will immediately send back a message indicating the current
      // serving status.  It will then subsequently send a new message whenever
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      void Check(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc::health::v1::HealthCheckResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void Check(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc::health::v1::HealthCheckResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void Check(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc::health::v1::HealthCheckResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  ...
  class ExperimentalWithCallbackMethod_Check : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_Check() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::health::v1::HealthCheckRequest, ::grpc::health::v1::HealthCheckResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::grpc::health::v1::HealthCheckRequest, ::grpc::health::v1::HealthCheckResponse>*>(handler)
    ...
    ExperimentalWithCallbackMethod_Watch() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(1,
          new ::grpc_impl::internal::CallbackServerStreamingHandler< ::grpc::health::v1::HealthCheckRequest, ::grpc::health::v1::HealthCheckResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
