...
static void InitDefaultsscc_info_CpuStat_cpu_5fstat_2eproto() {
  ...
  {
    void* ptr = &::linux_Monitor::_CpuStat_default_instance_;
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_cpu_5fstat_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::CpuStat, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::CpuStat, cpu_name_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::CpuStat, cpu_percent_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::CpuStat, usr_percent_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::CpuStat, system_percent_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::CpuStat, nice_percent_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::CpuStat, idle_percent_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::CpuStat, io_wait_percent_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::CpuStat, irq_percent_),
  PROTOBUF_FIELD_OFFSET(::linux_Monitor::CpuStat, soft_irq_percent_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::linux_Monitor::CpuStat)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::linux_Monitor::_CpuStat_default_instance_),
};

const char descriptor_table_protodef_cpu_5fstat_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016cpu_stat.proto\022\rlinux_Monitor\"\321\001\n\007CpuS"
...
CpuStat::CpuStat(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:linux_Monitor.CpuStat)
}
CpuStat::CpuStat(const CpuStat& from)
  ...
  // @@protoc_insertion_point(copy_constructor:linux_Monitor.CpuStat)
}
...
CpuStat::~CpuStat() {
  // @@protoc_insertion_point(destructor:linux_Monitor.CpuStat)
  SharedDtor();
...
void CpuStat::Clear() {
// @@protoc_insertion_point(message_clear_start:linux_Monitor.CpuStat)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "linux_Monitor.CpuStat.cpu_name"));
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* CpuStat::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:linux_Monitor.CpuStat)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->cpu_name().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "linux_Monitor.CpuStat.cpu_name");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:linux_Monitor.CpuStat)
  return target;
}

size_t CpuStat::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:linux_Monitor.CpuStat)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:linux_Monitor.CpuStat)
  GOOGLE_DCHECK_NE(&from, this);
  const CpuStat* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<CpuStat>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:linux_Monitor.CpuStat)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:linux_Monitor.CpuStat)
    MergeFrom(*source);
  }
}

void CpuStat::MergeFrom(const CpuStat& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:linux_Monitor.CpuStat)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:linux_Monitor.CpuStat)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:linux_Monitor.CpuStat)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::linux_Monitor::CpuStat* Arena::CreateMaybeMessage< ::linux_Monitor::CpuStat >(Arena* arena) {
  return Arena::CreateMessageInternal< ::linux_Monitor::CpuStat >(arena);
}
