...
PROTOBUF_NAMESPACE_OPEN
template<> ::linux_Monitor::CpuStat* Arena::CreateMaybeMessage<::linux_Monitor::CpuStat>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace linux_Monitor {
...
class CpuStat PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:linux_Monitor.CpuStat) */ {
 public:
  ...
  "    future release.")
  std::string* unsafe_arena_release_cpu_name();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_cpu_name(
      std::string* cpu_name);
  private:
  ...
  // @@protoc_insertion_point(class_scope:linux_Monitor.CpuStat)
 private:
  class _Internal;
...
inline const std::string& CpuStat::cpu_name() const {
  // @@protoc_insertion_point(field_get:linux_Monitor.CpuStat.cpu_name)
  return _internal_cpu_name();
}
inline void CpuStat::set_cpu_name(const std::string& value) {
  _internal_set_cpu_name(value);
  // @@protoc_insertion_point(field_set:linux_Monitor.CpuStat.cpu_name)
}
inline std::string* CpuStat::mutable_cpu_name() {
  // @@protoc_insertion_point(field_mutable:linux_Monitor.CpuStat.cpu_name)
...
inline void CpuStat::_internal_set_cpu_name(const std::string& value) {
  ...
  cpu_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void CpuStat::set_cpu_name(std::string&& value) {
  
  cpu_name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:linux_Monitor.CpuStat.cpu_name)
}
inline void CpuStat::set_cpu_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  cpu_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:linux_Monitor.CpuStat.cpu_name)
}
inline void CpuStat::set_cpu_name(const char* value,
    size_t size) {
  
  cpu_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:linux_Monitor.CpuStat.cpu_name)
}
inline std::string* CpuStat::_internal_mutable_cpu_name() {
  
  return cpu_name_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* CpuStat::release_cpu_name() {
  // @@protoc_insertion_point(field_release:linux_Monitor.CpuStat.cpu_name)
...
inline void CpuStat::set_allocated_cpu_name(std::string* cpu_name) {
  ...
  cpu_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), cpu_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:linux_Monitor.CpuStat.cpu_name)
}
inline std::string* CpuStat::unsafe_arena_release_cpu_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:linux_Monitor.CpuStat.cpu_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return cpu_name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void CpuStat::unsafe_arena_set_allocated_cpu_name(
    std::string* cpu_name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (cpu_name != nullptr) {
  ...
  cpu_name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      cpu_name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:linux_Monitor.CpuStat.cpu_name)
}
...
inline float CpuStat::cpu_percent() const {
  // @@protoc_insertion_point(field_get:linux_Monitor.CpuStat.cpu_percent)
...
inline void CpuStat::set_cpu_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:linux_Monitor.CpuStat.cpu_percent)
}
...
inline float CpuStat::usr_percent() const {
  // @@protoc_insertion_point(field_get:linux_Monitor.CpuStat.usr_percent)
...
inline void CpuStat::set_usr_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:linux_Monitor.CpuStat.usr_percent)
}
...
inline float CpuStat::system_percent() const {
  // @@protoc_insertion_point(field_get:linux_Monitor.CpuStat.system_percent)
...
inline void CpuStat::set_system_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:linux_Monitor.CpuStat.system_percent)
}
...
inline float CpuStat::nice_percent() const {
  // @@protoc_insertion_point(field_get:linux_Monitor.CpuStat.nice_percent)
...
inline void CpuStat::set_nice_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:linux_Monitor.CpuStat.nice_percent)
}
...
inline float CpuStat::idle_percent() const {
  // @@protoc_insertion_point(field_get:linux_Monitor.CpuStat.idle_percent)
...
inline void CpuStat::set_idle_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:linux_Monitor.CpuStat.idle_percent)
}
...
inline float CpuStat::io_wait_percent() const {
  // @@protoc_insertion_point(field_get:linux_Monitor.CpuStat.io_wait_percent)
...
inline void CpuStat::set_io_wait_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:linux_Monitor.CpuStat.io_wait_percent)
}
...
inline float CpuStat::irq_percent() const {
  // @@protoc_insertion_point(field_get:linux_Monitor.CpuStat.irq_percent)
...
inline void CpuStat::set_irq_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:linux_Monitor.CpuStat.irq_percent)
}
...
inline float CpuStat::soft_irq_percent() const {
  // @@protoc_insertion_point(field_get:linux_Monitor.CpuStat.soft_irq_percent)
...
inline void CpuStat::set_soft_irq_percent(float value) {
  ...
  // @@protoc_insertion_point(field_set:linux_Monitor.CpuStat.soft_irq_percent)
}
