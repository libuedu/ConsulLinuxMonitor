...
PROTOBUF_NAMESPACE_OPEN
template<> ::linux_Monitor::CpuLoad* Arena::CreateMaybeMessage<::linux_Monitor::CpuLoad>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace linux_Monitor {
...
class CpuLoad PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:linux_Monitor.CpuLoad) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:linux_Monitor.CpuLoad)
 private:
  class _Internal;
...
inline float CpuLoad::load_avg_1() const {
  // @@protoc_insertion_point(field_get:linux_Monitor.CpuLoad.load_avg_1)
...
inline void CpuLoad::set_load_avg_1(float value) {
  ...
  // @@protoc_insertion_point(field_set:linux_Monitor.CpuLoad.load_avg_1)
}
...
inline float CpuLoad::load_avg_3() const {
  // @@protoc_insertion_point(field_get:linux_Monitor.CpuLoad.load_avg_3)
...
inline void CpuLoad::set_load_avg_3(float value) {
  ...
  // @@protoc_insertion_point(field_set:linux_Monitor.CpuLoad.load_avg_3)
}
...
inline float CpuLoad::load_avg_15() const {
  // @@protoc_insertion_point(field_get:linux_Monitor.CpuLoad.load_avg_15)
...
inline void CpuLoad::set_load_avg_15(float value) {
  ...
  // @@protoc_insertion_point(field_set:linux_Monitor.CpuLoad.load_avg_15)
}
